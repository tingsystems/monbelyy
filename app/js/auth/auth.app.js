    ...
    function Routes($stateProvider) {
        $stateProvider
            ...
            .state('address', {
                ...
                data: {
                    requiredLogin: true,
                    pageTitle: 'Direcciones - Lady Paola'
                },
                views: {
                    'content': {
            ...
            .state('recovery-password', {
                ...
                data: {
                    pageTitle: 'Recuperar contraseña - Lady Paola'
                },
                views: {
                    'content': {
            ...
            .state('new-password', {
                ...
                data: {
                    pageTitle: 'Reestablecer contraseña - Lady Paola'
                },
                views: {
                    'content': {
                        templateUrl: '/templates/auth/recovery-password.html',
